...
public:
    ...
    sc_core::sc_in< int32_t > muffinMutPort;
    ...
    sc_core::sc_signal< sc_dt::sc_logic > core_alu_bcd_gnd;
    ...
    sc_dt::sc_lv< 4L > core_alu_bcd_addh_cry_qt197;
    ...
    const sc_core::sc_time core_alu_bcd_addh_hif_verilog_timescale_precision_wD091;
